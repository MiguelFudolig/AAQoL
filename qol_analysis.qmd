...
```{r}
qol_1 <- qol |> select(Family,Income_median,Ethnicity,`English Difficulties`) %>% filter(complete.cases(.)) |> 
  filter(Family %in%c("Yes","No")) |>  
  mutate(Family=droplevels(Family)) 
...
```{r}
qol_1 <- qol |> select(`Close Friend`,Income_median,Ethnicity,`English Difficulties`) %>% filter(complete.cases(.))
...
```{r}
qol_1 <- qol |> select(Acquaintances,Income_median,Ethnicity,`English Difficulties`) %>% filter(complete.cases(.))
glm(Acquaintances~Income_median+Ethnicity+`English Difficulties`,data=qol_1,family="binomial") -> mod1
summary(mod1)
car::Anova(mod1)
```
...
```{r}
qol_1 <- qol |> select(`Heal Professionals`,Income_median,Ethnicity,`English Difficulties`) %>% filter(complete.cases(.))
glm(`Heal Professionals`~Income_median+Ethnicity+`English Difficulties`,data=qol_1,family="binomial") -> mod1
summary(mod1)
car::Anova(mod1)
car::vif(mod1)
```
...
```{r}
qol_1 <- qol |> select(`Mobile Apps`,Income_median,Ethnicity,`English Difficulties`) %>% filter(complete.cases(.))
glm(`Mobile Apps`~Income_median+Ethnicity+`English Difficulties`,data=qol_1,family="binomial") -> mod1
summary(mod1)
car::Anova(mod1)
car::vif(mod1)
```
...
```{r}
qol_1 <- qol |> select(`Social Networks`,Income_median,Ethnicity,`English Difficulties`) %>% filter(complete.cases(.))
glm(`Social Networks`~Income_median+Ethnicity+`English Difficulties`,data=qol_1,family="binomial") -> mod1
summary(mod1)
car::Anova(mod1)
car::vif(mod1)
```
...
```{r}
qol_1 <- qol |> select(Email,Income_median,Ethnicity,`English Difficulties`) %>% filter(complete.cases(.))
glm(Email~Income_median+Ethnicity+`English Difficulties`,data=qol_1,family="binomial") -> mod1
summary(mod1)
car::Anova(mod1)
car::vif(mod1)
```
...
```{r}
qol_1 <- qol |> select(`Online Communities`,Income_median,Ethnicity,`English Difficulties`) %>% filter(complete.cases(.))
glm(`Online Communities`~Income_median+Ethnicity+`English Difficulties`,data=qol_1,family="binomial") -> mod1
summary(mod1)
car::Anova(mod1)
car::vif(mod1)
```
...
```{r}
qol_1 <- qol |> select(`Health Website`,Income_median,Ethnicity,`English Difficulties`) %>% filter(complete.cases(.))
glm(`Health Website`~Income_median+Ethnicity+`English Difficulties`,data=qol_1,family="binomial") -> mod1
summary(mod1)
car::Anova(mod1)
car::vif(mod1)
```
